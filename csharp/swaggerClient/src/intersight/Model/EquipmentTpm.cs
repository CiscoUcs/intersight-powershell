...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentTpm :  IEquatable<EquipmentTpm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentTpm" /> class.
        /// </summary>
        ...
        public EquipmentTpm(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), ComputeBoardRef ComputeBoard = default(ComputeBoardRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
        ...
        /// Gets or Sets TpmId
        /// </summary>
        [DataMember(Name="TpmId", EmitDefaultValue=false)]
        public long? TpmId { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TpmId: ").Append(TpmId).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentTpm);
        }

        /// <summary>
        /// Returns true if EquipmentTpm instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentTpm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentTpm other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.TpmId == other.TpmId ||
                    this.TpmId != null &&
                    this.TpmId.Equals(other.TpmId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TpmId != null)
                    hash = hash * 59 + this.TpmId.GetHashCode();
