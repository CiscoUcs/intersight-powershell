...
namespace intersight.Model
{
    ...
    public partial class InventoryGenericInventoryHolder :  IEquatable<InventoryGenericInventoryHolder>, IValidatableObject
    {
        ...
        public InventoryGenericInventoryHolder(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), ComputeBladeRef ComputeBlade = default(ComputeBladeRef), ComputeRackUnitRef ComputeRackUnit = default(ComputeRackUnitRef), List<InventoryGenericInventoryRef> GenericInventory = default(List<InventoryGenericInventoryRef>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
