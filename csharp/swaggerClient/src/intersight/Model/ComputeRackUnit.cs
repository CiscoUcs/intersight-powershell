...
namespace intersight.Model
{
    ...
    public partial class ComputeRackUnit :  IEquatable<ComputeRackUnit>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets PciDevices
        /// </summary>
        [DataMember(Name="PciDevices", EmitDefaultValue=false)]
        public List<PciDeviceRef> PciDevices { get; set; }
        ...
        /// <summary>
        /// Gets or Sets RackEnclosureSlot
        /// </summary>
        [DataMember(Name="RackEnclosureSlot", EmitDefaultValue=false)]
        public EquipmentRackEnclosureSlotRef RackEnclosureSlot { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PciDevices: ").Append(PciDevices).Append("\n");
            sb.Append("  Psus: ").Append(Psus).Append("\n");
            sb.Append("  RackEnclosureSlot: ").Append(RackEnclosureSlot).Append("\n");
        ...
        public bool Equals(ComputeRackUnit other)
        {
            ...
            return 
                ...
                (
                    this.PciDevices == other.PciDevices ||
                    this.PciDevices != null &&
                    this.PciDevices.SequenceEqual(other.PciDevices)
                ) && 
                (
                ...
                (
                    this.RackEnclosureSlot == other.RackEnclosureSlot ||
                    this.RackEnclosureSlot != null &&
                    this.RackEnclosureSlot.Equals(other.RackEnclosureSlot)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PciDevices != null)
                    hash = hash * 59 + this.PciDevices.GetHashCode();
                if (this.Psus != null)
                    hash = hash * 59 + this.Psus.GetHashCode();
                if (this.RackEnclosureSlot != null)
                    hash = hash * 59 + this.RackEnclosureSlot.GetHashCode();
