...
namespace intersight.Model
{
    ...
    public partial class IamIdpReference :  IEquatable<IamIdpReference>, IValidatableObject
    {
        ...
        /// <param name="Idp">Reference to System default Cisco IdP. .</param>
        ...
        public IamIdpReference(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), IamAccountRef Account = default(IamAccountRef), IamIdpRef Idp = default(IamIdpRef), List<IamUserLoginTimeRef> UserLoginTime = default(List<IamUserLoginTimeRef>), List<IamUserPreferenceRef> UserPreferences = default(List<IamUserPreferenceRef>), List<IamUserGroupRef> Usergroups = default(List<IamUserGroupRef>), List<IamUserRef> Users = default(List<IamUserRef>))
        {
        ...
        /// </summary>
        /// <value>Reference to System default Cisco IdP. </value>
        ...
        /// </summary>
        /// <value>Entity ID of the IdP. In SAML, the entity ID uniquely identifies the IdP/Service Provider.  </value>
        ...
        /// </summary>
        /// <value>Flag represents if multi factor authentication is required for Cisco IdP users.  </value>
        [DataMember(Name="MultiFactorAuthentication", EmitDefaultValue=false)]
        public bool? MultiFactorAuthentication { get; private set; }

        /// <summary>
        /// Cisco IdP reference in an account.   
        /// </summary>
        /// <value>Cisco IdP reference in an account.   </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MultiFactorAuthentication: ").Append(MultiFactorAuthentication).Append("\n");
        ...
        public bool Equals(IamIdpReference other)
        {
            ...
            return 
                ...
                (
                    this.MultiFactorAuthentication == other.MultiFactorAuthentication ||
                    this.MultiFactorAuthentication != null &&
                    this.MultiFactorAuthentication.Equals(other.MultiFactorAuthentication)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MultiFactorAuthentication != null)
                    hash = hash * 59 + this.MultiFactorAuthentication.GetHashCode();
                if (this.Name != null)
