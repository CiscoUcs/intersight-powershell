...
namespace intersight.Model
{
    ...
    public partial class FcPhysicalPort :  IEquatable<FcPhysicalPort>, IValidatableObject
    {
        ...
        public FcPhysicalPort(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), PortGroupRef PortGroup = default(PortGroupRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
