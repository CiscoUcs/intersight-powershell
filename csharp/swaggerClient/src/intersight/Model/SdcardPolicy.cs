...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SdcardPolicy :  IEquatable<SdcardPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Collection of partition   </value>
        [DataMember(Name="Partitions", EmitDefaultValue=false)]
        public List<SdcardPartition> Partitions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SdcardPolicy);
        }

        /// <summary>
        /// Returns true if SdcardPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of SdcardPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SdcardPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Partitions.SequenceEqual(other.Partitions)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Partitions != null)
                    hash = hash * 59 + this.Partitions.GetHashCode();
