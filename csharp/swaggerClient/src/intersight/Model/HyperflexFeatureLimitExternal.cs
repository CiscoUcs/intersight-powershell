...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HyperflexFeatureLimitExternal :  IEquatable<HyperflexFeatureLimitExternal>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HyperflexFeatureLimitExternal {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HyperflexFeatureLimitExternal);
        }

        /// <summary>
        /// Returns true if HyperflexFeatureLimitExternal instances are equal
        /// </summary>
        /// <param name="other">Instance of HyperflexFeatureLimitExternal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HyperflexFeatureLimitExternal other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
