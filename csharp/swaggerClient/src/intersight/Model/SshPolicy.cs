...
namespace intersight.Model
{
    ...
    public partial class SshPolicy :  IEquatable<SshPolicy>, IValidatableObject
    {
        ...
        public SshPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), string Description = default(string), string Name = default(string), bool? Enabled = default(bool?), IamAccountRef Organization = default(IamAccountRef), long? Port = default(long?), List<PolicyAbstractConfigProfileRef> Profiles = default(List<PolicyAbstractConfigProfileRef>), long? Timeout = default(long?))
        {
