...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PolicyAbstractConfigChangeDetail :  IEquatable<PolicyAbstractConfigChangeDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyAbstractConfigChangeDetail {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PolicyAbstractConfigChangeDetail);
        }

        /// <summary>
        /// Returns true if PolicyAbstractConfigChangeDetail instances are equal
        /// </summary>
        /// <param name="other">Instance of PolicyAbstractConfigChangeDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyAbstractConfigChangeDetail other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
