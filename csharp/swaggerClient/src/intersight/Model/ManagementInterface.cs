...
namespace intersight.Model
{
    ...
    public partial class ManagementInterface :  IEquatable<ManagementInterface>, IValidatableObject
    {
        ...
        public ManagementInterface(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), ManagementControllerRef ManagementController = default(ManagementControllerRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
