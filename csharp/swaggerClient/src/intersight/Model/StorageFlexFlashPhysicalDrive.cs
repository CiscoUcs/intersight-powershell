...
namespace intersight.Model
{
    ...
    public partial class StorageFlexFlashPhysicalDrive :  IEquatable<StorageFlexFlashPhysicalDrive>, IValidatableObject
    {
        ...
        public StorageFlexFlashPhysicalDrive(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), string CardStatus = default(string), string CardType = default(string), string OemId = default(string), string PdStatus = default(string), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), StorageFlexFlashControllerRef StorageFlexFlashController = default(StorageFlexFlashControllerRef))
        {
