...
namespace intersight.Model
{
    ...
    public partial class SecurityUnit :  IEquatable<SecurityUnit>, IValidatableObject
    {
        ...
        public SecurityUnit(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), ComputeBoardRef ComputeBoard = default(ComputeBoardRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
