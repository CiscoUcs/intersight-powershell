...
namespace intersight.Model
{
    ...
    public partial class TestcryptAdministrator :  IEquatable<TestcryptAdministrator>, IValidatableObject
    {
        ...
        public TestcryptAdministrator(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), IamAccountRef Account = default(IamAccountRef), TestcryptUser Admin = default(TestcryptUser))
        {
