...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentRackEnclosure :  IEquatable<EquipmentRackEnclosure>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentRackEnclosure" /> class.
        /// </summary>
        ...
        public EquipmentRackEnclosure(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), List<EquipmentFanModuleRef> Fanmodules = default(List<EquipmentFanModuleRef>), List<EquipmentPsuRef> Psus = default(List<EquipmentPsuRef>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<EquipmentRackEnclosureSlotRef> Slots = default(List<EquipmentRackEnclosureSlotRef>))
        {
        ...
        public List<EquipmentRackEnclosureSlotRef> Slots { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentRackEnclosure {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentRackEnclosure);
        }

        /// <summary>
        /// Returns true if EquipmentRackEnclosure instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentRackEnclosure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentRackEnclosure other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
