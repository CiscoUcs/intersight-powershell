...
namespace intersight.Model
{
    ...
    public partial class GraphicsController :  IEquatable<GraphicsController>, IValidatableObject
    {
        ...
        public GraphicsController(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), GraphicsCardRef GraphicsCard = default(GraphicsCardRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
