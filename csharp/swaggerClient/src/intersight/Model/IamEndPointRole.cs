...
{
    /// <summary>
    /// EndPointRole represents a role defined in the end point which can be assigned to a user. 
    /// </summary>
    [DataContract]
    public partial class IamEndPointRole :  IEquatable<IamEndPointRole>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Privileges assigned to this end point role. These privileges are assigned to users using end point roles to perform operations such as GUI/CLI cross launch. </value>
        ...
        /// </summary>
        /// <value>Used to specify tags to roles such as ep-admin, ep-readonly.  </value>
