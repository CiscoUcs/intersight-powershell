...
namespace intersight.Model
{
    ...
    public partial class StorageController :  IEquatable<StorageController>, IValidatableObject
    {
        ...
        /// <param name="VirtualDriveExtensions">VirtualDriveExtensions.</param>
        /// <param name="VirtualDrives">VirtualDrives.</param>
        public StorageController(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), ComputeBoardRef ComputeBoard = default(ComputeBoardRef), List<StoragePhysicalDiskExtensionRef> PhysicalDiskExtensions = default(List<StoragePhysicalDiskExtensionRef>), List<StoragePhysicalDiskRef> PhysicalDisks = default(List<StoragePhysicalDiskRef>), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef), List<FirmwareRunningFirmwareRef> RunningFirmware = default(List<FirmwareRunningFirmwareRef>), string SelfEncryptEnabled = default(string), List<StorageVirtualDriveExtensionRef> VirtualDriveExtensions = default(List<StorageVirtualDriveExtensionRef>), List<StorageVirtualDriveRef> VirtualDrives = default(List<StorageVirtualDriveRef>))
        {
            ...
            this.VirtualDriveExtensions = VirtualDriveExtensions;
        ...
        /// <summary>
        /// Gets or Sets VirtualDriveExtensions
        /// </summary>
        [DataMember(Name="VirtualDriveExtensions", EmitDefaultValue=false)]
        public List<StorageVirtualDriveExtensionRef> VirtualDriveExtensions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VirtualDriveExtensions: ").Append(VirtualDriveExtensions).Append("\n");
        ...
        public bool Equals(StorageController other)
        {
            ...
            return 
                ...
                (
                    this.VirtualDriveExtensions == other.VirtualDriveExtensions ||
                    this.VirtualDriveExtensions != null &&
                    this.VirtualDriveExtensions.SequenceEqual(other.VirtualDriveExtensions)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VirtualDriveExtensions != null)
                    hash = hash * 59 + this.VirtualDriveExtensions.GetHashCode();
