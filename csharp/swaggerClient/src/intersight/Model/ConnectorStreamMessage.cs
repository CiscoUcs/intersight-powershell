...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectorStreamMessage :  IEquatable<ConnectorStreamMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectorStreamMessage" /> class.
        /// </summary>
        /// <param name="StreamName">The requested stream name. Stream names are unique per device endpoint.   .</param>
        public ConnectorStreamMessage(string StreamName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectorStreamMessage {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConnectorStreamMessage);
        }

        /// <summary>
        /// Returns true if ConnectorStreamMessage instances are equal
        /// </summary>
        /// <param name="other">Instance of ConnectorStreamMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectorStreamMessage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
