...
namespace intersight.Model
{
    ...
    public partial class PolicyAbstractConfigResult :  IEquatable<PolicyAbstractConfigResult>, IValidatableObject
    {
        ...
        public PolicyAbstractConfigResult(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), string ConfigStage = default(string), string ConfigState = default(string), string ValidationState = default(string))
        {
