...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HyperflexFeatureLimitEntry :  IEquatable<HyperflexFeatureLimitEntry>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HyperflexFeatureLimitEntry {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HyperflexFeatureLimitEntry);
        }

        /// <summary>
        /// Returns true if HyperflexFeatureLimitEntry instances are equal
        /// </summary>
        /// <param name="other">Instance of HyperflexFeatureLimitEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HyperflexFeatureLimitEntry other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
