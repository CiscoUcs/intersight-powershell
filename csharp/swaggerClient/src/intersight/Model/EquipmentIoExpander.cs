...
namespace intersight.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EquipmentIoExpander :  IEquatable<EquipmentIoExpander>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentIoExpander {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EquipmentIoExpander);
        }

        /// <summary>
        /// Returns true if EquipmentIoExpander instances are equal
        /// </summary>
        /// <param name="other">Instance of EquipmentIoExpander to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentIoExpander other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
