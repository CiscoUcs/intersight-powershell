...
namespace intersight.Model
{
    ...
    public partial class HyperflexSysConfigPolicy :  IEquatable<HyperflexSysConfigPolicy>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>DNS Search Domain Name. This applies to HyperFlex Data Platform 3.0 or later only.  </value>
        [DataMember(Name="DnsDomainName", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DnsDomainName: ").Append(DnsDomainName).Append("\n");
        ...
        public bool Equals(HyperflexSysConfigPolicy other)
        {
            ...
            return 
                ...
                (
                    this.DnsDomainName == other.DnsDomainName ||
                    this.DnsDomainName != null &&
                    this.DnsDomainName.Equals(other.DnsDomainName)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DnsDomainName != null)
                    hash = hash * 59 + this.DnsDomainName.GetHashCode();
