...
namespace intersight.Model
{
    ...
    public partial class EquipmentSystemIoController :  IEquatable<EquipmentSystemIoController>, IValidatableObject
    {
        ...
        public EquipmentSystemIoController(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), EquipmentChassisRef EquipmentChassis = default(EquipmentChassisRef), AssetDeviceRegistrationRef RegisteredDevice = default(AssetDeviceRegistrationRef))
        {
