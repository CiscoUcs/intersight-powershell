...
namespace intersight.Model
{
    ...
    public partial class EquipmentBase :  IEquatable<EquipmentBase>, IValidatableObject
    {
        ...
        public EquipmentBase(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext))
        {
