...
{
    /// <summary>
    /// Represents the status of a device connectors connection to Intersight. 
    /// </summary>
    [DataContract]
    public partial class AssetDeviceConnection :  IEquatable<AssetDeviceConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetDeviceConnection" /> class.
        /// </summary>
        ...
        public AssetDeviceConnection(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetDeviceConnection {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AssetDeviceConnection);
        }

        /// <summary>
        /// Returns true if AssetDeviceConnection instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetDeviceConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetDeviceConnection other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
