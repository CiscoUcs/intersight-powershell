...
namespace intersight.Model
{
    ...
    public partial class ExternalsiteAuthorization :  IEquatable<ExternalsiteAuthorization>, IValidatableObject
    {
        ...
        public ExternalsiteAuthorization(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), IamAccountRef Account = default(IamAccountRef), bool? IsPasswordSet = default(bool?), bool? IsUserIdSet = default(bool?), string Password = default(string), RepositoryTypeEnum? RepositoryType = RepositoryTypeEnum.Cisco, string UserId = default(string))
        {
