...
namespace intersight.Model
{
    ...
    public partial class SnmpPolicy :  IEquatable<SnmpPolicy>, IValidatableObject
    {
        ...
        public SnmpPolicy(List<MoBaseMoRef> Ancestors = default(List<MoBaseMoRef>), string Moid = default(string), List<string> Owners = default(List<string>), MoBaseMoRef Parent = default(MoBaseMoRef), List<MoTag> Tags = default(List<MoTag>), MoVersionContext VersionContext = default(MoVersionContext), string Description = default(string), string Name = default(string), string AccessCommunityString = default(string), CommunityAccessEnum? CommunityAccess = CommunityAccessEnum.Disabled, bool? Enabled = default(bool?), string EngineId = default(string), IamAccountRef Organization = default(IamAccountRef), List<PolicyAbstractConfigProfileRef> Profiles = default(List<PolicyAbstractConfigProfileRef>), long? SnmpPort = default(long?), List<SnmpTrap> SnmpTraps = default(List<SnmpTrap>), List<SnmpUser> SnmpUsers = default(List<SnmpUser>), string SysContact = default(string), string SysLocation = default(string), string TrapCommunity = default(string))
        {
