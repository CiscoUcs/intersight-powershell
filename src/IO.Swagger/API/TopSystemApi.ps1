function Invoke-TopSystemApiTopSystemsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: TopSystemApi-TopSystemsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TopSystemApi.TopSystemsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-TopSystemApiTopSystemsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: TopSystemApi-TopSystemsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TopSystemApi.TopSystemsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
...
function Invoke-TopSystemApiTopSystemsMoidPatch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: TopSystemApi-TopSystemsMoidPatch' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TopSystemApi.TopSystemsMoidPatch(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
...
function Invoke-TopSystemApiTopSystemsMoidPost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: TopSystemApi-TopSystemsMoidPost' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TopSystemApi.TopSystemsMoidPost(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
