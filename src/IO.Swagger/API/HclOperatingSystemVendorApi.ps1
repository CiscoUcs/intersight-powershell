function Invoke-HclOperatingSystemVendorApiHclOperatingSystemVendorsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HclOperatingSystemVendorApi-HclOperatingSystemVendorsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HclOperatingSystemVendorApi.HclOperatingSystemVendorsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-HclOperatingSystemVendorApiHclOperatingSystemVendorsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HclOperatingSystemVendorApi-HclOperatingSystemVendorsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HclOperatingSystemVendorApi.HclOperatingSystemVendorsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
