function Invoke-ServerConfigResultEntryApiServerConfigResultEntriesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ServerConfigResultEntryApi-ServerConfigResultEntriesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ServerConfigResultEntryApi.ServerConfigResultEntriesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-ServerConfigResultEntryApiServerConfigResultEntriesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ServerConfigResultEntryApi-ServerConfigResultEntriesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ServerConfigResultEntryApi.ServerConfigResultEntriesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
