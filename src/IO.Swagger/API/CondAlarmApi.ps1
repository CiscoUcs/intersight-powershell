function Invoke-CondAlarmApiCondAlarmsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondAlarmApi-CondAlarmsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondAlarmApi.CondAlarmsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-CondAlarmApiCondAlarmsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondAlarmApi-CondAlarmsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondAlarmApi.CondAlarmsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
