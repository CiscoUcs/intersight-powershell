function Invoke-FirmwareUpgradeStatusApiFirmwareUpgradeStatusesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: FirmwareUpgradeStatusApi-FirmwareUpgradeStatusesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:FirmwareUpgradeStatusApi.FirmwareUpgradeStatusesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-FirmwareUpgradeStatusApiFirmwareUpgradeStatusesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: FirmwareUpgradeStatusApi-FirmwareUpgradeStatusesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:FirmwareUpgradeStatusApi.FirmwareUpgradeStatusesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
