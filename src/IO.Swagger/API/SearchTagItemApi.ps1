function Invoke-SearchTagItemApiSearchTagItemsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: SearchTagItemApi-SearchTagItemsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:SearchTagItemApi.SearchTagItemsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-SearchTagItemApiSearchTagItemsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: SearchTagItemApi-SearchTagItemsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:SearchTagItemApi.SearchTagItemsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
