function Invoke-IamUserApiIamUsersGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: IamUserApi-IamUsersGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:IamUserApi.IamUsersGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-IamUserApiIamUsersMoidDelete {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: IamUserApi-IamUsersMoidDelete' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:IamUserApi.IamUsersMoidDelete(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
...
function Invoke-IamUserApiIamUsersMoidGet {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: IamUserApi-IamUsersMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-IamUserApiIamUsersPost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [intersight.Model.IamUser]
    ...
    Process {
        'Calling method: IamUserApi-IamUsersPost' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:IamUserApi.IamUsersPost(
            ${body},
            ${body2},
            ${body3},
            ${body4},
