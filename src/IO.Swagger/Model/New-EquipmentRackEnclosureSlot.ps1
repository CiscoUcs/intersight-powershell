function New-EquipmentRackEnclosureSlot {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: intersight.Model.EquipmentRackEnclosureSlot' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName intersight.Model.EquipmentRackEnclosureSlot -ArgumentList @(
            ${AccountMoid},
            ${Ancestors},
            ${CreateTime},
            ${ModTime},
