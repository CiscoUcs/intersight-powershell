function New-EquipmentRackEnclosure {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: intersight.Model.EquipmentRackEnclosure' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName intersight.Model.EquipmentRackEnclosure -ArgumentList @(
            ${AccountMoid},
            ${Ancestors},
            ${CreateTime},
            ${ModTime},
