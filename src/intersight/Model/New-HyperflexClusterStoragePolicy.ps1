function New-HyperflexClusterStoragePolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: intersight.Model.HyperflexClusterStoragePolicy' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName intersight.Model.HyperflexClusterStoragePolicy -ArgumentList @(
            ${AccountMoid},
            ${Ancestors},
            ${CreateTime},
            ${ModTime},
