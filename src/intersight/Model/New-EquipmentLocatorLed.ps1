function New-EquipmentLocatorLed {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: intersight.Model.EquipmentLocatorLed' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName intersight.Model.EquipmentLocatorLed -ArgumentList @(
            ${AccountMoid},
            ${Ancestors},
            ${CreateTime},
            ${ModTime},
