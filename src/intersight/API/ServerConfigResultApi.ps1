function Invoke-ServerConfigResultApiServerConfigResultsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ServerConfigResultApi-ServerConfigResultsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ServerConfigResultApi.ServerConfigResultsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-ServerConfigResultApiServerConfigResultsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ServerConfigResultApi-ServerConfigResultsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ServerConfigResultApi.ServerConfigResultsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
