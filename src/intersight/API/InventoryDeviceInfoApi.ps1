function Invoke-InventoryDeviceInfoApiInventoryDeviceInfosGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: InventoryDeviceInfoApi-InventoryDeviceInfosGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:InventoryDeviceInfoApi.InventoryDeviceInfosGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-InventoryDeviceInfoApiInventoryDeviceInfosMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: InventoryDeviceInfoApi-InventoryDeviceInfosMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:InventoryDeviceInfoApi.InventoryDeviceInfosMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
