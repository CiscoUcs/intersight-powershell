function Invoke-TerminalAuditLogApiTerminalAuditLogsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: TerminalAuditLogApi-TerminalAuditLogsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TerminalAuditLogApi.TerminalAuditLogsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-TerminalAuditLogApiTerminalAuditLogsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: TerminalAuditLogApi-TerminalAuditLogsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TerminalAuditLogApi.TerminalAuditLogsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
