function Invoke-StoragePhysicalDiskUsageApiStoragePhysicalDiskUsagesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: StoragePhysicalDiskUsageApi-StoragePhysicalDiskUsagesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:StoragePhysicalDiskUsageApi.StoragePhysicalDiskUsagesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-StoragePhysicalDiskUsageApiStoragePhysicalDiskUsagesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: StoragePhysicalDiskUsageApi-StoragePhysicalDiskUsagesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:StoragePhysicalDiskUsageApi.StoragePhysicalDiskUsagesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
...
function Invoke-StoragePhysicalDiskUsageApiStoragePhysicalDiskUsagesMoidPatch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [intersight.Model.StoragePhysicalDiskUsage]
        ${body},
        [Parameter(Position = 2, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid2},
    ...
    Process {
        'Calling method: StoragePhysicalDiskUsageApi-StoragePhysicalDiskUsagesMoidPatch' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:StoragePhysicalDiskUsageApi.StoragePhysicalDiskUsagesMoidPatch(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
...
function Invoke-StoragePhysicalDiskUsageApiStoragePhysicalDiskUsagesMoidPost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: StoragePhysicalDiskUsageApi-StoragePhysicalDiskUsagesMoidPost' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:StoragePhysicalDiskUsageApi.StoragePhysicalDiskUsagesMoidPost(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
