function Invoke-AdapterUnitApiAdapterUnitsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: AdapterUnitApi-AdapterUnitsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:AdapterUnitApi.AdapterUnitsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-AdapterUnitApiAdapterUnitsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: AdapterUnitApi-AdapterUnitsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:AdapterUnitApi.AdapterUnitsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
