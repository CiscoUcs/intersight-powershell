function Invoke-CondHclStatusJobApiCondHclStatusJobsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondHclStatusJobApi-CondHclStatusJobsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondHclStatusJobApi.CondHclStatusJobsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-CondHclStatusJobApiCondHclStatusJobsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondHclStatusJobApi-CondHclStatusJobsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondHclStatusJobApi.CondHclStatusJobsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
