function Invoke-HyperflexConfigResultEntryApiHyperflexConfigResultEntriesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HyperflexConfigResultEntryApi-HyperflexConfigResultEntriesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HyperflexConfigResultEntryApi.HyperflexConfigResultEntriesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-HyperflexConfigResultEntryApiHyperflexConfigResultEntriesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HyperflexConfigResultEntryApi-HyperflexConfigResultEntriesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HyperflexConfigResultEntryApi.HyperflexConfigResultEntriesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
