function Invoke-HyperflexNodeApiHyperflexNodesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HyperflexNodeApi-HyperflexNodesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HyperflexNodeApi.HyperflexNodesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-HyperflexNodeApiHyperflexNodesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HyperflexNodeApi-HyperflexNodesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HyperflexNodeApi.HyperflexNodesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
