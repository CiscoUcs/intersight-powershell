function Invoke-IamEndPointPrivilegeApiIamEndPointPrivilegesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: IamEndPointPrivilegeApi-IamEndPointPrivilegesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:IamEndPointPrivilegeApi.IamEndPointPrivilegesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-IamEndPointPrivilegeApiIamEndPointPrivilegesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: IamEndPointPrivilegeApi-IamEndPointPrivilegesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:IamEndPointPrivilegeApi.IamEndPointPrivilegesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
