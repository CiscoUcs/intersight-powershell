function Invoke-DeviceinfoSerialNumberInfoApiDeviceinfoSerialNumberInfosGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: DeviceinfoSerialNumberInfoApi-DeviceinfoSerialNumberInfosGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:DeviceinfoSerialNumberInfoApi.DeviceinfoSerialNumberInfosGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-DeviceinfoSerialNumberInfoApiDeviceinfoSerialNumberInfosMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: DeviceinfoSerialNumberInfoApi-DeviceinfoSerialNumberInfosMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:DeviceinfoSerialNumberInfoApi.DeviceinfoSerialNumberInfosMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
