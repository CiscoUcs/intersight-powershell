function Invoke-ManagementInterfaceApiManagementInterfacesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ManagementInterfaceApi-ManagementInterfacesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ManagementInterfaceApi.ManagementInterfacesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-ManagementInterfaceApiManagementInterfacesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ManagementInterfaceApi-ManagementInterfacesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ManagementInterfaceApi.ManagementInterfacesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
...
function Invoke-ManagementInterfaceApiManagementInterfacesMoidPatch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [intersight.Model.ManagementInterface]
        ${body},
        [Parameter(Position = 2, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid2},
    ...
    Process {
        'Calling method: ManagementInterfaceApi-ManagementInterfacesMoidPatch' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ManagementInterfaceApi.ManagementInterfacesMoidPatch(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
...
function Invoke-ManagementInterfaceApiManagementInterfacesMoidPost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: ManagementInterfaceApi-ManagementInterfacesMoidPost' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ManagementInterfaceApi.ManagementInterfacesMoidPost(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
