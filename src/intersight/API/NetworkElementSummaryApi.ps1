function Invoke-NetworkElementSummaryApiNetworkElementSummariesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: NetworkElementSummaryApi-NetworkElementSummariesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:NetworkElementSummaryApi.NetworkElementSummariesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-NetworkElementSummaryApiNetworkElementSummariesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: NetworkElementSummaryApi-NetworkElementSummariesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:NetworkElementSummaryApi.NetworkElementSummariesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
