function Invoke-WorkflowPendingDynamicWorkflowInfoApiWorkflowPendingDynamicWorkflowInfosGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: WorkflowPendingDynamicWorkflowInfoApi-WorkflowPendingDynamicWorkflowInfosGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:WorkflowPendingDynamicWorkflowInfoApi.WorkflowPendingDynamicWorkflowInfosGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-WorkflowPendingDynamicWorkflowInfoApiWorkflowPendingDynamicWorkflowInfosMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: WorkflowPendingDynamicWorkflowInfoApi-WorkflowPendingDynamicWorkflowInfosMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:WorkflowPendingDynamicWorkflowInfoApi.WorkflowPendingDynamicWorkflowInfosMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
