function Invoke-TestcryptShadowCredentialApiTestcryptShadowCredentialsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: TestcryptShadowCredentialApi-TestcryptShadowCredentialsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TestcryptShadowCredentialApi.TestcryptShadowCredentialsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-TestcryptShadowCredentialApiTestcryptShadowCredentialsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: TestcryptShadowCredentialApi-TestcryptShadowCredentialsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:TestcryptShadowCredentialApi.TestcryptShadowCredentialsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
