function Invoke-ComputeServerSettingApiComputeServerSettingsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ComputeServerSettingApi-ComputeServerSettingsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ComputeServerSettingApi.ComputeServerSettingsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-ComputeServerSettingApiComputeServerSettingsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: ComputeServerSettingApi-ComputeServerSettingsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ComputeServerSettingApi.ComputeServerSettingsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
...
function Invoke-ComputeServerSettingApiComputeServerSettingsMoidPatch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [intersight.Model.ComputeServerSetting]
        ${body},
        [Parameter(Position = 2, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid2},
    ...
    Process {
        'Calling method: ComputeServerSettingApi-ComputeServerSettingsMoidPatch' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ComputeServerSettingApi.ComputeServerSettingsMoidPatch(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
...
function Invoke-ComputeServerSettingApiComputeServerSettingsMoidPost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: ComputeServerSettingApi-ComputeServerSettingsMoidPost' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:ComputeServerSettingApi.ComputeServerSettingsMoidPost(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
