function Invoke-HclOperatingSystemApiHclOperatingSystemsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HclOperatingSystemApi-HclOperatingSystemsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HclOperatingSystemApi.HclOperatingSystemsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-HclOperatingSystemApiHclOperatingSystemsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HclOperatingSystemApi-HclOperatingSystemsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HclOperatingSystemApi.HclOperatingSystemsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
