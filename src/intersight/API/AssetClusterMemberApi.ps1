function Invoke-AssetClusterMemberApiAssetClusterMembersGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: AssetClusterMemberApi-AssetClusterMembersGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:AssetClusterMemberApi.AssetClusterMembersGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-AssetClusterMemberApiAssetClusterMembersMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: AssetClusterMemberApi-AssetClusterMembersMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:AssetClusterMemberApi.AssetClusterMembersMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
