function Invoke-CondHclStatusDetailApiCondHclStatusDetailsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondHclStatusDetailApi-CondHclStatusDetailsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondHclStatusDetailApi.CondHclStatusDetailsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-CondHclStatusDetailApiCondHclStatusDetailsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondHclStatusDetailApi-CondHclStatusDetailsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondHclStatusDetailApi.CondHclStatusDetailsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
