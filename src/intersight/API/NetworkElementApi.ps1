function Invoke-NetworkElementApiNetworkElementsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: NetworkElementApi-NetworkElementsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:NetworkElementApi.NetworkElementsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-NetworkElementApiNetworkElementsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: NetworkElementApi-NetworkElementsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:NetworkElementApi.NetworkElementsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
...
function Invoke-NetworkElementApiNetworkElementsMoidPatch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [intersight.Model.NetworkElement]
        ${body},
        [Parameter(Position = 2, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
        ${moid2},
    ...
    Process {
        'Calling method: NetworkElementApi-NetworkElementsMoidPatch' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:NetworkElementApi.NetworkElementsMoidPatch(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
...
function Invoke-NetworkElementApiNetworkElementsMoidPost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [String]
    ...
    Process {
        'Calling method: NetworkElementApi-NetworkElementsMoidPost' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:NetworkElementApi.NetworkElementsMoidPost(
            ${moid},
            ${body},
            ${moid2},
            ${body2},
