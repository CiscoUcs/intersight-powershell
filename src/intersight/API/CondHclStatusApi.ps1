function Invoke-CondHclStatusApiCondHclStatusesGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondHclStatusApi-CondHclStatusesGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondHclStatusApi.CondHclStatusesGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-CondHclStatusApiCondHclStatusesMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: CondHclStatusApi-CondHclStatusesMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:CondHclStatusApi.CondHclStatusesMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
