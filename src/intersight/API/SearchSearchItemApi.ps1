function Invoke-SearchSearchItemApiSearchSearchItemsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: SearchSearchItemApi-SearchSearchItemsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:SearchSearchItemApi.SearchSearchItemsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-SearchSearchItemApiSearchSearchItemsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: SearchSearchItemApi-SearchSearchItemsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:SearchSearchItemApi.SearchSearchItemsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
