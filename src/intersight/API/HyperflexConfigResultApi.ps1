function Invoke-HyperflexConfigResultApiHyperflexConfigResultsGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HyperflexConfigResultApi-HyperflexConfigResultsGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HyperflexConfigResultApi.HyperflexConfigResultsGet(
            ${$count},
            ${$inlinecount},
            ${$top},
            ${$skip},
...
function Invoke-HyperflexConfigResultApiHyperflexConfigResultsMoidGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: HyperflexConfigResultApi-HyperflexConfigResultsMoidGet' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $Script:HyperflexConfigResultApi.HyperflexConfigResultsMoidGet(
            ${moid},
            ${moid2},
            ${moid3},
            ${moid4},
